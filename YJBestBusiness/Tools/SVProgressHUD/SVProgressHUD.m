...
+(void)showWithWithMaskClearStatue:(NSString *)status
{
...
+ (void)showErrorCustomerWithStatus:(NSString *)string
{
    
    [self showCusImage:[[self sharedView] hudErrorImage] status:string];
